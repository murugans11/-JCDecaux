package com.murugan.bankintest.ui.base
...
import com.murugan.bankintest.di.component.DaggerViewHolderComponent
import com.murugan.bankintest.di.component.ViewHolderComponent
import com.murugan.bankintest.di.module.ViewHolderModule
import com.murugan.bankintest.utils.display.Toaster
...
abstract class BaseItemViewHolder<T : Any, VM : BaseItemViewModel<T>>(
    ...
    private fun buildViewHolderComponent() =
        DaggerViewHolderComponent
            .builder()
            .applicationComponent((itemView.context.applicationContext as BankingApplication).applicationComponent)
